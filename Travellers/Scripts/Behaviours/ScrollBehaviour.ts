class ScrollBehaviour implements IBehaviour {
    ...
    constructor(private dir: Direction, private speed: number) {
        ...
        this._x = dir === Direction.Left || dir === Direction.Right ? Constants.CELL_SIZE * this._xDirection * -1 : 0;
        this._y = dir === Direction.Up || dir === Direction.Down ? Constants.CELL_SIZE * this._yDirection * -1 : 0;
    }
